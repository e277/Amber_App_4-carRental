<x-app-layout>
    ...
    <div class="grid">
        <div class="py-12 grid-cols-1">
            <div class="bg-gray-200 w-20">Sidebar</div>

        </div>

        <div class="py-12 grid-cols-4">
                                    ...
                                    <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
                                        ...
                                        <div class="flex items-center justify-center mt-8">
                                            <div class="flex items-center">
                                                <span
                                                    class="text-gray-800 dark:text-white text-2xl font-semibold">Dashboard</span>
                                            </div>
                                        </div>
                                        ...
                                        <header class="flex justify-between items-center p-6">
                                            ...
                                            <div class="flex items-center space-x-4">
                                                <button @click="darkMode = !darkMode"
                                                    ...
                                                    <svg x-show="darkMode" class="h-6 w-6" viewBox="0 0 20 20"
                                                        fill="currentColor">
